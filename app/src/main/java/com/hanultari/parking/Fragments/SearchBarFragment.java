package com.hanultari.parking.Fragments;
...
public class SearchBarFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.google.android.material.button.MaterialButton btnMenu = getView().findViewById(R.id.btnMenu);
        btnMenu.setBackgroundColor(ContextCompat.getColor(getActivity(), R.color.gray));
    }
